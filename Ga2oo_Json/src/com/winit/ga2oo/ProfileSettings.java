...
import com.winit.ga2oo.xmlparsers.Ga2ooParsers;
import com.winit.ga2oo.xmlparsers.ParseUserCurrentLocationBasedOnZip;
...
public class ProfileSettings extends Activity implements LocationResult
{
	...
	private List<com.winit.ga2oo.objects.UpdateProfile> vctUpdateData=null;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		rellayAddLocation.setOnClickListener(new OnClickListener()
		{
			...
			{
				showLocation();
				Intent intent = new Intent(ProfileSettings.this, com.winit.ga2oo.MyMapActivity.class);
...
//					int status=objGa2ooParsers.removeSavedLocation(locationId);
    ...
    public void onResume()
    {
        ...
        TabsActivity.btnLogout.setOnClickListener(new OnClickListener()
        {
			...
			public void onClick(View v) 
			{
				vctUpdateData=new ArrayList<com.winit.ga2oo.objects.UpdateProfile>();
				com.winit.ga2oo.objects.UpdateProfile objupdateProfile=new com.winit.ga2oo.objects.UpdateProfile();
