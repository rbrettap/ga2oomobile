...
import com.winit.ga2oo.xmlparsers.LocationDeleteWrapper;
import com.winit.ga2oo.xmlparsers.UrlPost;
...
public class Ga2ooJsonParsers {
	...
	public static int registerNewUser(List<com.winit.ga2oo.objects.Registration> vctRegData)
	{
...
//			strRequest.append("\n");
	...
	public static int changeUserPrimaryLocation(int locationId)
	{
		...
		try
		{
			...
			URL url = new URL(AppConstants.JSON_HOST_URL+AppConstants.UPDTAE_PROFILE);
				HttpURLConnection connection = (HttpURLConnection)url.openConnection();
				connection.setDoInput(true);
				connection.setDoOutput(true);
				connection.setUseCaches(false);
	...
	public static int updateUserProfile(List<com.winit.ga2oo.objects.UpdateProfile> vctUpdateprofile){
