...
public class LoginButton extends ImageButton {
    ...
    public void init(final Activity activity, final Facebook fb) {
    	init(activity, fb, new String[] {"publish_stream", "read_stream", "offline_access"});
    }
...
//        setImageResource(fb.isSessionValid() ? R.drawable.facebook_logout_button : R.drawable.facebook_login_button);
